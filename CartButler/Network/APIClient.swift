...
final class APIClient: APIClientProvider, Sendable {
  ...
  static private let defaulURL = URL(string: "https://southern-shard-449119-d4.nn.r.appspot.com/api")!
  ...
  func delete(
    ...
    try await performEmptyResponseRequest(path: path, method: .delete, queryParameters: queryParameters)
  }
  ...
  private func performRequest<T: Decodable>(
    ...
    guard (200 ... 299).contains(httpResponse.statusCode) else {
      ...
      let error = NSError(domain: "Network error", code: httpResponse.statusCode, userInfo: userInfo)
  ...
  private func performEmptyResponseRequest(
    ...
    do {
      let _: EmptyResponse = try await performRequest(path: path, method: method, queryParameters: queryParameters, body: body)
